...
* **Zero Dependencies:** Pure Vanilla HTML, CSS, and JavaScript all contained within a single `index.html` file. No build tools, no frameworks, no external libraries.
...
Since this is a standalone utility, there is no installation or server required.
